...
use Aptenex\Upp\Parser\Structure\Condition\MonthsCondition;
use Aptenex\Upp\Parser\Structure\Condition\WeeksCondition;

class MonthsConditionEvaluator implements ConditionEvaluationInterface
{
    ...
    public function evaluate(PricingContext $context, Condition $condition, ControlItemInterface $controlItem)
    {
        ...
        // Now we've got the nights we need to convert this into months
        $noMatched = floor($noMatched / 30);
